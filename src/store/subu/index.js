...
export default {
    ...
    state: {
        ...
        sinavTanimlama: JSON.parse(localStorage.getItem('sinavTanimlama')),
    ...
    getters: {
        ...
        getSinavTanimlama(state){
            return state.sinavTanimlama
        },
    },
    mutations: {
        ...
        changeSinavTanimlama(state,val){
            state.sinavTanimlama = val
        },
    },
    actions: {
        ...
        changeSinavTanimlari({commit},val){
            commit('changeSinavTanimlama', val)
        }
    },
}
